...
while_cond:                                       ; preds = %match_case5.i, %entry-block
  ...
  %8 = icmp eq i8* %7, %5
  br i1 %8, label %match_case5.i, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i"

"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i": ; preds = %while_cond
  %9 = getelementptr inbounds i8* %7, i64 1
  %10 = icmp eq i8* %7, null
  br i1 %10, label %match_case5.i, label %match_case.i3

match_case.i3:                                    ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i"
...
match_case5.i:                                    ; preds = %match_case68.i, %match_case58.i, %match_case49.i, %match_case39.i, %match_case30.i, %match_case21.i, %compare_next12.i, %match_case11.i, %match_case9.i, %match_case.i3, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i", %while_cond
  %37 = phi i8* [ %9, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ %22, %match_case21.i ], [ %27, %match_case39.i ], [ %35, %match_case68.i ], [ %9, %compare_next12.i ], [ %5, %while_cond ], [ %5, %match_case9.i ], [ %5, %match_case11.i ], [ %5, %match_case30.i ], [ %5, %match_case49.i ], [ %5, %match_case58.i ], [ %9, %match_case.i3 ]
  %__make_return_pointer.sroa.0.0.i = phi i1 [ false, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ true, %match_case21.i ], [ true, %match_case39.i ], [ true, %match_case68.i ], [ false, %compare_next12.i ], [ false, %while_cond ], [ false, %match_case9.i ], [ false, %match_case11.i ], [ false, %match_case30.i ], [ false, %match_case49.i ], [ false, %match_case58.i ], [ true, %match_case.i3 ]
  %__make_return_pointer.sroa.13.0.i = phi i8 [ undef, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ %11, %match_case21.i ], [ %11, %match_case39.i ], [ %11, %match_case68.i ], [ undef, %compare_next12.i ], [ undef, %while_cond ], [ undef, %match_case9.i ], [ undef, %match_case11.i ], [ undef, %match_case30.i ], [ undef, %match_case49.i ], [ undef, %match_case58.i ], [ %11, %match_case.i3 ]
  %__make_return_pointer.sroa.18.0.i = phi i8 [ undef, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ %23, %match_case21.i ], [ %26, %match_case39.i ], [ %30, %match_case68.i ], [ undef, %compare_next12.i ], [ undef, %while_cond ], [ undef, %match_case9.i ], [ undef, %match_case11.i ], [ undef, %match_case30.i ], [ undef, %match_case49.i ], [ undef, %match_case58.i ], [ 0, %match_case.i3 ]
  %__make_return_pointer.sroa.23.0.i = phi i8 [ undef, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ 0, %match_case21.i ], [ %28, %match_case39.i ], [ %34, %match_case68.i ], [ undef, %compare_next12.i ], [ undef, %while_cond ], [ undef, %match_case9.i ], [ undef, %match_case11.i ], [ undef, %match_case30.i ], [ undef, %match_case49.i ], [ undef, %match_case58.i ], [ 0, %match_case.i3 ]
  %__make_return_pointer.sroa.28.0.i = phi i32 [ 0, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i" ], [ 0, %match_case21.i ], [ 0, %match_case39.i ], [ %phitmp12, %match_case68.i ], [ 0, %compare_next12.i ], [ 0, %while_cond ], [ 0, %match_case9.i ], [ 0, %match_case11.i ], [ 0, %match_case30.i ], [ 0, %match_case49.i ], [ 0, %match_case58.i ], [ 0, %match_case.i3 ]
...
entry-block:
  ...
  %4 = load i64* %3, align 8
  %5 = icmp eq i64 %4, 0
  br i1 %5, label %_ZN7Bencher4iter20h5651727382402855893E.exit, label %for_body.lr.ph.i
...
for_body.i:                                       ; preds = %for_body.i, %for_body.lr.ph.i
  ...
  br i1 %exitcond.i, label %_ZN7Bencher4iter20h5651727382402855893E.exit.loopexit, label %for_body.i

_ZN7Bencher4iter20h5651727382402855893E.exit.loopexit: ; preds = %for_body.i
  br label %_ZN7Bencher4iter20h5651727382402855893E.exit

_ZN7Bencher4iter20h5651727382402855893E.exit:     ; preds = %_ZN7Bencher4iter20h5651727382402855893E.exit.loopexit, %entry-block
...
while_exit:                                       ; preds = %while_cond, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i", %match_case5.i
...
while_cond:                                       ; preds = %match_case5.i, %entry-block
  ...
  br i1 %3, label %while_exit, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i"
...
match_else.i:                                     ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h10563832042746447825E.exit.i"
...
normal-return2:                                   ; preds = %normal-return
  ...
  %14 = icmp eq i64 %13, 0
  br i1 %14, label %"_ZN56collections..vec..Vec$LT$collections..string..String$GT$14glue_drop.160917h06b37c7794b5fe3bE.exit21", label %then-block-1292-.i.i11

then-block-1292-.i.i11:                           ; preds = %normal-return2
  %15 = getelementptr inbounds %"struct.collections::string::String<[]>[#6]"* %3, i64 %5
  %16 = icmp eq i64 %5, 0
  br i1 %16, label %for_exit.i.i12, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13.preheader"

"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13.preheader": ; preds = %then-block-1292-.i.i11
  br label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13"

for_exit.i.i12.loopexit:                          ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13", %for_loopback.backedge.i.i17
...
for_exit.i.i12:                                   ; preds = %for_exit.i.i12.loopexit, %then-block-1292-.i.i11
  ...
  br label %"_ZN56collections..vec..Vec$LT$collections..string..String$GT$14glue_drop.160917h06b37c7794b5fe3bE.exit21"

"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13": ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13.preheader", %for_loopback.backedge.i.i17
  %18 = phi %"struct.collections::string::String<[]>[#6]"* [ %19, %for_loopback.backedge.i.i17 ], [ %3, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13.preheader" ]
...
for_body.i.i16:                                   ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13"
...
for_loopback.backedge.i.i17:                      ; preds = %then-block-1292-.i.i.i.i.i20, %for_body.i.i16
  ...
  br i1 %22, label %for_exit.i.i12.loopexit, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i13"
...
"_ZN56collections..vec..Vec$LT$collections..string..String$GT$14glue_drop.160917h06b37c7794b5fe3bE.exit21": ; preds = %normal-return2, %for_exit.i.i12
  call void @llvm.lifetime.end(i64 24, i8* %1)
  ret void
...
then-block-1292-.i.i:                             ; preds = %unwind_ast_155_3
  ...
  %28 = icmp eq i64 %5, 0
  br i1 %28, label %for_exit.i.i, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i.preheader"

"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i.preheader": ; preds = %then-block-1292-.i.i
  br label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i"

for_exit.i.i.loopexit:                            ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i", %for_loopback.backedge.i.i
...
"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i": ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i.preheader", %for_loopback.backedge.i.i
  %30 = phi %"struct.collections::string::String<[]>[#6]"* [ %31, %for_loopback.backedge.i.i ], [ %3, %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i.preheader" ]
...
for_body.i.i:                                     ; preds = %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i"
...
for_loopback.backedge.i.i:                        ; preds = %then-block-1292-.i.i.i.i.i, %for_body.i.i
  ...
  br i1 %34, label %for_exit.i.i.loopexit, label %"_ZN5slice57Items$LT$$x27a$C$$x20T$GT$.Iterator$LT$$BP$$x27a$x20T$GT$4next21h11651490863995559773E.exit.i.i"
